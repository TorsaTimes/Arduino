...
static const char* ssid = "WIFINAME";                           //  WIFI SSID
static const char* password = "WIFIPASSWD";                   //  WIFI Password

/* MQTT Settings */
/* MQTT Client name is set to WIFI host from Wifi Settings*/
static const char* mqtt_host = "HOSTIP";                       //  MQTT Broker server ip
static const char* mqtt_user = "mqtt-user";                         //  MQTT Broker username. If empty or NULL, no authentication will be used
static const char* mqtt_pass = "MQTTPASSWD";                         //  MQTT Broker password
...
static std::map<std::string, std::string> allBots = {
    { "BoseOff", "E7:89:11:38:1F:D7" },
    { "BoseOn", "FA:71:54:45:0F:20" }
};
...
static std::map<std::string, std::string> allPasswords = {     // Set all the bot passwords (setup in app first). Ignore if passwords are not used
    /*{ "BoseOff", "mm7NQF67B^9ip&eohE8Ax29gMkTMby6yX!orVh$rGZDS^dQoqnTHmDerV!TB5C*Cmb#uYLWCqA4c&i@nW%curzHvs2PhTSpYvCo5iFoGLP7CMyYq6fG3Tfu#i4x^YMag" },
    { "BoseOn", "*nV!dCPC#UFTanFGiSAmd!D&ZC^6CqHu$mgc#Gxn%MPTD98s7X3bSrt&fE7mE66MeYFCX$KzvS%Lse$a$TG5CmymTaFiLV84PYn$CjSsKXtHZTuGMxPqLt5zL!%W^pDj" }*/
};
